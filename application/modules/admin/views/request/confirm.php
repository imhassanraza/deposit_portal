...
<div class="row wrapper border-bottom white-bg page-heading">
    <div class="col-lg-10">
        <h2><?php echo lang('confirmed_request'); ?></h2>
        <ol class="breadcrumb">
            <li>
                <a href="<?php echo admin_url(); ?>">Home</a>
            </li>
            <li class="active">
                <strong><?php echo lang('confirmed_request'); ?></strong>
            </li>
        </ol>
    ...
    <div class="col-lg-12">
        <form id="add_bank_form" class="form-horizontal" method="post" action="<?php echo admin_url() ?>request/searchRequest">
            <div class="col-lg-6">
                <input type="hidden" name="requestType" value="Confirmed">
                ...
                <div class="form-group"><label class="col-sm-2 control-label"><?php echo lang('deposit_amount'); ?></label>
                    <div class="col-sm-10"><input type="text" name="deposit_amount" id="deposit_amount" class="form-control" placeholder="<?php echo lang('please_enter_deposit_amount');?>"></div>
                </div>
                <div class="hr-line-dashed"></div>
            </div>
            <div class="col-lg-6">
    ...
    <div class="wrapper wrapper-content animated fadeInRight">
                            ...
                            <table class="table table-striped table-bordered dt-responsive nowrap" id="tttt">
                                ...
                                <thead>
                                    <tr>
                                        ...
                                        <th><?php echo lang('confirm_by');?></th>
        ...
        <script type="text/javascript">
            $(document).ready(function() {
                // setInterval(function(){getConfirmRequests();}, 10000);

                function getConfirmRequests()
                {
                    $.ajax({
                        url:'<?php echo admin_url(); ?>request/search_confirmed',
                        type:'post',
                        dataType:'json',
                        success:function(status){
                            if(status.msg=='success'){
                                $(".confirmTable").html(status.response);
                            }
