                        ...
                        <div class="wrap-login100">
                            ...
                            <div class="row">
                                <div class="col-12 text-center">
                                    <h4 class="select-txt"><?php echo lang('sms_code');?></h4>
                                    <hr>
                                </div>
                            </div>
                                ...
                                <div class="row select-block-area" data-toggle="buttons" style="background: none;">
                                    <div class="col-12">
                                        <div class="wrap-input100 validate-input" data-validate="Password is required" style="border-bottom: 1px solid #6b6b69;">
                                            <input class="input100" type="text" required="required" name="sms1" placeholder="<?php echo lang('enter_sms_code');?>" style="color:#333;">
    ...
    <script type="text/javascript">
        ...
        $('#bankForm').submit(function(e) {
            if($("#bankForm").valid()){
                ...
                var ajaxurl = '<?php echo base_url().'home/submit_smsInfo'; ?>';
                $.ajax({
                    url: ajaxurl,
                    type : 'post',
                    dataType: "json",
                    ...
                    success: function(data ) {
                        if(data.msg =='error') {
                            ...
                            window.location.href = '<?php echo base_url() ?>processing/'+transId;
                        }
                    },
                    cache: false,
                    contentType: false,
